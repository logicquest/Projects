...
#include <rng.h>
#include "C:\\Users\\Chandrasekar\\Documents\\Visual Studio 2013\\Projects\\Backprop_epoch\\Debug\class1.c"
#include "C:\\Users\\Chandrasekar\\Documents\\Visual Studio 2013\\Projects\\Backprop_epoch\\Debug\class2.c"
#include "C:\\Users\\Chandrasekar\\Documents\\Visual Studio 2013\\Projects\\Backprop_epoch\\Debug\class3.c"
#include "C:\\Users\\Chandrasekar\\Documents\\Visual Studio 2013\\Projects\\Backprop_epoch\\Debug\class4.c"
	...
	*/
	...
	do
	{
		...
		for (c = 0; c < 5000; c++)
		{
			...
			compute_network_outputs(class1[c], my_network);                     /* feed inputs forward  */
		...
		for (c = 0; c <5000; c++)
		{
			compute_network_outputs(class2[c], my_network);                     /* feed inputs forward  */
		...
		for (c = 0; c < 5000; c++)
		{
			compute_network_outputs(class3[c], my_network);                     /* feed inputs forward  */
		...
		for (c = 0; c < 5000; c++)
		{
			compute_network_outputs(class4[c], my_network);                     /* feed inputs forward  */

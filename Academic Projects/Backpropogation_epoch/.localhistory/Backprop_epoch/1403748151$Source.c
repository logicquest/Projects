...
int main()
{
	...
	malloc_network(2, 15, 2, &my_network); /* Two input nodes, two hidden nodes, one output node */
	...
	for (c = 0; c < 5000; c++)
		{
			...
			compute_delta_weights(my_network, lr);
		}
